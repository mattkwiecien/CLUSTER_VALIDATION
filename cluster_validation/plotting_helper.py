...
class PlottingHelper(object):
    ...
    def M_DES_SV(l, z, Omega_m_z0):
        ...
        F = 1.12
        G = 0.18   
        return PlottingHelper.mass_richness_parametrization(l_new, z, Omega_m_z0, M0, l0, z0, F, G, mass_def="crit")
    ...
    def M_SDSS(l, z, Omega_m_z0):
        ...
        z0 = 0.2
        F = 1.30   #+- 0.09
        return PlottingHelper.mass_richness_parametrization(l_new, z, Omega_m_z0, M0, l0, z0, F, 0, mass_def="crit")
    ...
    def M_DES_Y1(l, z, Omega_m_z0):
        ...
        F = 1.356   #+-0.051 +-0.008
        G = -0.30   #+-0.30 +-0.06
        return PlottingHelper.mass_richness_parametrization(l, z, Omega_m_z0, M0, l0, z0, F, G, mass_def="crit")
