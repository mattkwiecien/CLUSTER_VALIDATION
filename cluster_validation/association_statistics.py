...
class AssociationStatistics(object):
    
    @staticmethod
    def number_of_associations(ind_bij):
        """ Compute the number of bijective associatons.

             #parameters: the truth catalog
             :param ind_bij : array containing the indices of bijective associated objects in both catalogs

             #results:
             :return: bij_number : the total number of bijective associatons

        """
        bij_number = len(ind_bij)
        return bij_number
    ...
    def overmerging(det_to_truth_match, ind_bij, method="bij"):
        ...
        ovmg_fraction = ovmg_number/AssociationStatistics.number_of_associations(ind_bij)
        if method == "one way":
    ...
    def fragmentation(truth_to_det_match, ind_bij, method="bij"):
        ...
        frag_fraction = frag_number/AssociationStatistics.number_of_associations(ind_bij)
        if method == "one way":
    ...
    def completeness(truth_data, ind_bij, gc, gc_truth):
        ...
        number_of_match = AssociationStatistics.number_of_associations(ind_bij)
